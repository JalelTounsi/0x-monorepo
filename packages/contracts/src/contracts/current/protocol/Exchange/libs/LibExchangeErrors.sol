...
contract LibExchangeErrors {
    ...
    string constant LENGTH_1_REQUIRED = "LENGTH_1_REQUIRED";                // Byte array must have a length of 1.
    string constant LENGTH_66_REQUIRED = "LENGTH_66_REQUIRED";              // Byte array must have a length of 66.
}
